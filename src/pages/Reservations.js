      ...
      <main className={classes.reservations}>
        ...
        <div className={classes.reservations__pageBtn}>
          <IconContext.Provider value={
            { 
              size: "75px",
              className: classes.reservations__pageBtnIcon + ' ' + classes.reservations__pageBtnIconLeft, 
              title: "window close button"
            }
          }>
            <AiFillRightCircle onClick={goToHome}/>
        ...
        <div className={classes.reservations__pageBtn}>
          <IconContext.Provider value={
            { 
              size: "75px",
              className: classes.reservations__pageBtnIcon, 
              title: "window close button"
            }
          }>
